...
video_path = "SEKAI_Bad_apple!!.mp4" # change mp4 file path for different version of Bad Apple!!
audio_path = "SEKAI_Bad_apple!!.mp3" # change mp3 file path for different version of Bad Apple!!
# Example
    # Original Version
...
# Don't forget to change Ascii Character on every version
...
start_time = time.time()  # time tracking (making sure every frames counts)
...
while cap.isOpened():
    ...
    # Convert frame to grayscale (buhahahah)
...
# Made by Lorenz Christian G. Villones from DLSU-D STM112 
# This took me days just to align the timing of the frame for with both Bad Apple!! Versions
# And also whipping another several hours for the ascii characters
# https://github.com/xvllnzoch
# For any concerns email me at lorenzchristianvillones@gmail.com
